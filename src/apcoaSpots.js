// ── PARTNER, AS OF 18 AUG 2026 ───────────────────────────────────────────────
// partner:true on every row. APCOA and ParkEasy have agreed a commercial
// partnership covering these sites; the flag is what stops them being ranked
// as a competitor (see eventParking.js) and is what the card badge reads.
//
// WHAT THE FLAG DOES NOT CLAIM. It does not say a bay is bookable through
// ParkEasy, and it must not: the Belfast listings are still status='draft'
// with no agreed price, no bay count and no Stripe account, and the discounted
// booking link has not arrived. Tariffs below are APCOA's own public barrier
// rates, shown as information, exactly as they were before.
//
